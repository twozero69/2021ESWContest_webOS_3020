...
const ControlHospital = ({patientData, hospitalData, ambulanceDistance}) => {
    return(
        <>
            <Header patientData={patientData} name="병원제어" outline="병원의 시설을 조작 또는 예약합니다." ambulanceDistance={ambulanceDistance} />
